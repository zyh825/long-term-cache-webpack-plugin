 ...
 * @constructor
 */
function LogTermCahingPlugin({ replaceRules, appHtmlSrcPath, appHtmlDstPath, srcPath, distPath }) {
  this.options = {
...
LogTermCahingPlugin.prototype = {
  constructor: LogTermCahingPlugin,
...
module.exports = LogTermCahingPlugin;